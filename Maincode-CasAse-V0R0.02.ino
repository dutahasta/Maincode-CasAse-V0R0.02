...
// ======================================
void sendDisplayData(CPState state, float tempC, float acVoltage, float acCurrent, float acPower, float acEnergy, float cpVoltage)
{
  Serial1.print("TEMP:");
  ...
  Serial1.print("AC:");
  Serial1.print(acVoltage,1);
  Serial1.print("V ");

  Serial1.print("I:");
  Serial1.print(acCurrent,2);
  Serial1.print("A ");

  Serial1.print("P:");
  Serial1.print(acPower,1);
  Serial1.print("W ");

  Serial1.print("E:");
  Serial1.print(acEnergy,3);
  Serial1.print("kWh ");

  Serial1.print("CP:");
  Serial1.print(cpVoltage,3);
  Serial1.print("V ");
...
void sendRS485Packet(MeterValuePacket_t *packet)
{
  ...
  buffer[index++] = packet->crc16 & 0xFF;
  buffer[index++] = (packet->crc16 >> 8) & 0xFF;
...
void loop()
{
  ...
  sendDisplayData(newState, tempC, acVoltage, acCurrent, acPower, acEnergy, cpVoltage);
